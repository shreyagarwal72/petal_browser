 ...
 * ─────────────────────────────────────────────────────────────────────────
 * Main Material 3 Settings Screen for Petal Browser (Play Store Variant).
...
fun PetalSettingsScreen(
    ...
    var targetHighlightItemId by remember { mutableStateOf<String?>(null) }

    val isCategoryDrilled = currentCategory != SettingsCategory.OVERVIEW
            ...
            Box(modifier = Modifier.fillMaxSize()) {
                PetalScreenWrapper(isBehind = true) {
                    SettingsHubScreen(
                        ...
                        onCategoryClick = { category, itemId ->
                            targetHighlightItemId = itemId
...
private fun RenderCategoryContent(
    ...
    when (category) {
        ...
        SettingsCategory.API_INTEGRATIONS -> {
            ApiIntegrationsSettingsScreen(targetHighlightItemId = targetHighlightItemId, onNavigateBack = onNavigateBack)
        }
        SettingsCategory.APPEARANCE -> {
            AppearanceSettingsScreen(targetHighlightItemId = targetHighlightItemId, onNavigateBack = onNavigateBack)
        }
        SettingsCategory.PRIVACY -> {
            PrivacySettingsScreen(targetHighlightItemId = targetHighlightItemId, onNavigateBack = onNavigateBack)
        }
        SettingsCategory.SEARCH_HOMEPAGE -> {
            SearchHomeSettingsScreen(targetHighlightItemId = targetHighlightItemId, onNavigateBack = onNavigateBack)
        }
        ...
        SettingsCategory.MISCELLANEOUS -> {
            MiscSettingsScreen(targetHighlightItemId = targetHighlightItemId, onNavigateBack = onNavigateBack)
        }
        SettingsCategory.DATA_STORAGE -> {
            DataBackupSettingsScreen(targetHighlightItemId = targetHighlightItemId, onNavigateBack = onNavigateBack)
        }
        ...
        SettingsCategory.ABOUT -> {
            AboutSettingsScreen(targetHighlightItemId = targetHighlightItemId, onNavigateBack = onNavigateBack)
        }
    }
}
